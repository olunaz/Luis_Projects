...
Sub pegar_Trimestre()
    ...
    ws_visaclasica_ch.Range("B7").Value = trimestre
    ws_visagold_ch.Range("B7").Value = trimestre
    ws_visacbsn_ch.Range("B7").Value = trimestre
    ws_visacorp_ch.Range("B7").Value = trimestre
    ws_visaplat_ch.Range("B7").Value = trimestre
    ws_visasig_ch.Range("B7").Value = trimestre
    ws_visacta_ch.Range("B7").Value = trimestre
    ws_visainf_ch.Range("B7").Value = trimestre
    ws_visadebemp_ch.Range("B7").Value = trimestre
    ws_visauclsd_ch.Range("B7").Value = trimestre
    ws_visagift_ch.Range("B7").Value = trimestre
...
Sub exportar_Texto()
  ...
  wb.Activate
    ...
    ws_txt.Cells(15, k + 1).Value = ws_visaclasica_ch.Cells(k + r, 2).Value
    ws_txt.Cells(16, k + 1).Value = ws_visagold_ch.Cells(k + r, 2).Value
    ws_txt.Cells(17, k + 1).Value = ws_visacbsn_ch.Cells(k + r, 2).Value
    ws_txt.Cells(18, k + 1).Value = ws_visacorp_ch.Cells(k + r, 2).Value
    ws_txt.Cells(19, k + 1).Value = ws_visaplat_ch.Cells(k + r, 2).Value
    ws_txt.Cells(20, k + 1).Value = ws_visasig_ch.Cells(k + r, 2).Value
    ws_txt.Cells(21, k + 1).Value = ws_visacta_ch.Cells(k + r, 2).Value
    ws_txt.Cells(22, k + 1).Value = ws_visainf_ch.Cells(k + r, 2).Value
    ws_txt.Cells(23, k + 1).Value = ws_visadebemp_ch.Cells(k + r, 2).Value
    ws_txt.Cells(24, k + 1).Value = ws_visauclsd_ch.Cells(k + r, 2).Value
    ws_txt.Cells(25, k + 1).Value = ws_visagift_ch.Cells(k + r, 2).Value
    ...
    FileName = ThisWorkbook.Path & "\VolumenVentasVisa " & Format(Now(), "DD-MMM-YYYY hh mm AMPM") & ".txt"
...
Sub borrado()
 ...
 'BORRADO DE VALORES CALCULADOS
     
    Set ws_valoresAquirientes = wb.Sheets("Valores_Adquirientes")
    
    'sheetname.Range("D4").ClearContents
    'sheetname.Range("F9:I20").ClearContents

End Sub


Sub modifica_Values_Tarjetas()
  ...
  Dim inifila As Integer, inicolumna As Integer, l As Integer
  Set ws_visaclasica = wb.Sheets("VISA_CCLS-CH")
  Set ws_visagold = wb.Sheets("VISA_GOLD-CH")
  Set ws_visacbsn = wb.Sheets("VISA_CBSN-CH")
  Set ws_visacorp = wb.Sheets("VISA_CORP-CH")
  Set ws_visaplat = wb.Sheets("VISA_PLAT-CH")
  Set ws_visasig = wb.Sheets("VISA_SIG-CH")
  Set ws_visacta = wb.Sheets("VISA_CTA-CH")
  Set ws_visainf = wb.Sheets("VISA_INF-CH")
  Set ws_visadebemp = wb.Sheets("VISA_DBSN-CH")
  Set ws_visauclsd = wb.Sheets("VISA_UCLSD-CH")
  Set ws_visagift = wb.Sheets("VISA_GIFT-CH")
 ...
 Do While (l < 1000)
   If (ws2.Cells(inifila, inicolumna).Value) = "VISACLASICA" Then
     Call CopiadoValoresTarjetasChips(ws_visaclasica, inifila, ws2)
 ...
 Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISAORO" Then
   Call CopiadoValoresTarjetasChips(ws_visagold, inifila, ws2)
...
'VISA CAPTA TRABAJO
 ...
 Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISACAPTRABAJO" Then
    Call CopiadoValoresTarjetasChips(ws_visacbsn, inifila, ws2)
...
'VISA CORPORATE ORO
 ...
 Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISACORPORATEORO" Then
   Call CopiadoValoresTarjetasChips(ws_visacorp, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISAPLATINUM" Then
   Call CopiadoValoresTarjetasChips(ws_visaplat, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISASIGNATURE" Then
   Call CopiadoValoresTarjetasChips(ws_visasig, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISACUENTAVIAJES" Then
   Call CopiadoValoresTarjetasChips(ws_visacta, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "BBVASE" Then
   Call CopiadoValoresTarjetasChips(ws_visainf, inifila, ws2)
...
'TARJETAS DE DEBITO
 ...
 Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISA_DEBITO_EMP" Then
   Call CopiadoValoresTarjetasChips(ws_visadebemp, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISADEBITO" Then
   Call CopiadoValoresTarjetasChips(ws_visauclsd, inifila, ws2)
...
Do While (l < 1000)
  If (ws2.Cells(inifila, inicolumna).Value) = "VISAREGALO" Then
   Call CopiadoValoresTarjetasChips(ws_visagift, inifila, ws2)
  End If
  inifila = inifila + 1
  l = l + 1
Loop
